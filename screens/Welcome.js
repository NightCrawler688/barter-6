...
import { StyleSheet, Text, View,Image, TextInput,TouchableOpacity,Alert,ScrollView,Modal,KeyboardAvoidingView} from 'react-native';
          ...
          <View style = {styles.modalContainer}>
            ...
            <KeyboardAvoidingView style = {styles.KeyboardAvoidingView}>
               ...
               <TextInput style = {styles.formTextInput} placeholder = {'First Name'} maxLength = {8} onChangeText = {(text)=>{
                ...
                <TextInput style = {styles.formTextInput} placeholder = {'abc@example.com'}  onChangeText = {(text)=>{
                   this.setState({
                     emailId:text
                   })
  ...
  render(){
    return(
      <View style = {styles.container}>
        ...
        <Image source = {require('../assets/barter.jpg')} style = {{width:100,height:100}}/>
